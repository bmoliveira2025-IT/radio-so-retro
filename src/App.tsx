...
const fallbackStations: Station[] = [
  { id: 'heart-80s', name: 'Heart 80s', frequency: '80S HITS', url: 'https://media-ssl.musicradio.com/Heart80sMP3', color: '#ff1493' },
  { id: 'heart-90s', name: 'Heart 90s', frequency: '90S HITS', url: 'https://media-ssl.musicradio.com/Heart90sMP3', color: '#4facfe' },
        ...
        if (data && data.length > 0) {
          ...
          const apiStations: Station[] = validData.map((st: any, index: number) => {
            ...
            return {
              ...
              logo: undefined   // No external images — artwork generated by CSS
            };
          });
